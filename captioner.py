...
file_types = [("JPEG (*.jpg)", "*.jpg", "*.png"), ("All files (*.*)", "*.*")]
...
\\end{figure}
    ...
    while True:
        filename = (
            imgs.pop()
        )  # This crashes the program when finished. But like, a cool crash.
        ...
        if event == "-MLINE-_Enter" or event == "Add":
            ...
            try:
                ...
                print(
                    "Something went wrong with the file. Check permissions, or create a 'outputs.tex' file in this directory"
                )
